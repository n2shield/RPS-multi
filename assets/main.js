$(document).on('ready', function() {
	// Links to Firebase
	var database = new Firebase("https://in-class-c3184.firebaseio.com");
	var presenceRef = new Firebase('https://in-class-c3184.firebaseio.com/.info/connected');
	var playersRef = new Firebase('https://in-class-c3184.firebaseio.com/playersRef');
	var turnRef = new Firebase('https://in-class-c3184.firebaseio.com/turn');
	var chatRef = new Firebase('https://in-class-c3184.firebaseio.com/chat');
